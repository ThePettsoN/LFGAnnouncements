...
LFGAnnouncements.Instances.Register("DUNGEONS", Utils.game.GameExpansionLookup.Wotlk, Dungeons)
LFGAnnouncements.Instances.Register("RAIDS", Utils.game.GameExpansionLookup.Wotlk, Raids)
