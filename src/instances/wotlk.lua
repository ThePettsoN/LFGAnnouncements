...
LFGAnnouncements.Instances.Register("DUNGEONS", GameUtils.GameVersionLookup.WOTLK, Dungeons)
LFGAnnouncements.Instances.Register("RAIDS", GameUtils.GameVersionLookup.WOTLK, Raids)
