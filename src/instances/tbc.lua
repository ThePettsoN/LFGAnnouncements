...
LFGAnnouncements.Instances.Register("DUNGEONS", GameUtils.GameVersionLookup.TBC, Dungeons)
LFGAnnouncements.Instances.Register("RAIDS", GameUtils.GameVersionLookup.TBC, Raids)
