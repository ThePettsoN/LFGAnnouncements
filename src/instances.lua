...
utils.tMergeRecursive(Dungeons, WrathDungeons)

local Raids = {}
utils.tMergeRecursive(Raids, BurningCrusadeRaids)
utils.tMergeRecursive(Raids, WrathRaids)
